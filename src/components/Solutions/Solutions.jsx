...
import { FaMobileAlt, FaDatabase, FaProjectDiagram, FaRocket, FaCheck, FaClock } from 'react-icons/fa';
import StackingPanels from './components/StackingPanels/StackingPanels';
import './styles/SolutionsPage.css';

const dashboardImages = [
  { img: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=800', title: 'تطبيق الهاتف' },
  { img: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800', title: 'تحليل البيانات' },
  { img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800', title: 'إدارة المشاريع' },
  { img: 'https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=800', title: 'الحل الشامل' },
];

const solutionsImage = "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=800";
      ...
      <section className="solutions-hero">
        <div className="container">
          ...
          <p className="hero-description">
            مجموعة شاملة من الحلول الإضافية التي تطور بها عملك إلى مستوى جديد
          </p>
