          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <Link to="/hr" className="modern-card block bg-white rounded-2xl md:rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              <div className="h-40 md:h-48 relative overflow-hidden">
                ...
                <span className="absolute top-3 right-3 bg-white/90 text-primary px-3 py-1 rounded-lg text-xs font-bold">الأكثر شمولاً</span>
              </div>
              <div className="p-5 md:p-6 md:p-7">
                ...
                <ul className="pt-4 md:pt-5 border-t border-gray-100">
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>إدارة ملفات الموظفين</li>
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>مسير الرواتب والتعويضات</li>
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>الحضور والانصراف</li>
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>الامتثال للقوانين والتقارير</li>
                </ul>
              </div>
            </Link>
            <Link to="/finance" className="modern-card block bg-white rounded-2xl md:rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="p-5 md:p-6 md:p-7">
                ...
                <ul className="pt-4 md:pt-5 border-t border-gray-100">
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>إدارة المبيعات والفواتير</li>
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>المحاسبة العامة والحسابات</li>
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>إدارة المخزون والمستودعات</li>
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>التقارير المالية والتحليلات</li>
                </ul>
              </div>
            </Link>
            <Link to="/talent" className="modern-card block bg-white rounded-2xl md:rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="p-5 md:p-6 md:p-7">
                ...
                <ul className="pt-4 md:pt-5 border-t border-gray-100">
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>إدارة التوظيف والمقابلات</li>
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>تقييم الأداء 360 درجة</li>
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>التدريب والتطوير</li>
                  <li className="text-sm text-gray-600 py-2 flex items-center gap-2"><span className="text-primary">←</span>إدارة المسارات الوظيفية</li>
                </ul>
              </div>
            </Link>
          </div>
